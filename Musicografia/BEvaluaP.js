...
{   
  ...
  window.speechSynthesis.cancel();
   ...
   if(event.keyCode == 18){
     ...
     // alert(vozselec[0]+ " / " +  vozselec[1]);
      //ssu.voice =tts[vozselec[0]];
    ...
    event.preventDefault();
    window.speechSynthesis.cancel();
    var Tex = document.getElementById('EtiquetaUnoTexto').innerHTML;
    //var Br = Tex.substring(Tex.length -1);

     msgNo = new SpeechSynthesisUtterance('borró  la última letra');
     ...
     var r = Tex.substring(0,Tex.length -1);
      //alert(r);
    document.getElementById('EtiquetaUnoTexto').innerHTML = r;

    //document.getElementById("mimg").src ="./Letras/T.png";
    ...
    */}
    ...
    if(event.keyCode == 13){/*
    event.preventDefault();
    Tex = document.getElementById('EtiquetaUnoTexto').innerHTML;
     msgNo = new SpeechSynthesisUtterance(Tex);
     msgNo.voice = speechSynthesis.getVoices()[Voz];
     msgNo.rate = 0.8;			   
     sayTimeout = setTimeout(function () { window.speechSynthesis.speak(msgNo);}, 500); 
   return;
            ...
            Pb = Pb.toString();
             arrayN = Pb.split(",");
               ...
               for (var i=0; i < arrayN.length; i++) {
                ...
                document.getElementById(elemento).src="../../Res/Punto"+valorE+".png";
                document.getElementById(elementoT).src="../../Res/TSi.png";
...
$("#pequen").attr("src","Peque.png");
 ...
 ColorGlobo();		   
  ...
  msgNo.onend = function(event) {
    EsperaAnim(); 
   for (var i=1; i < 7; i++) {
        $('#P'+i).attr('src', '../../Res/Punto.png');
        $('#T'+i).attr('src', '../../Res/TNo.png');        
     } 
      Dicta = Dicta +1;   
...
*/
 ...
 function NoExiste()
    ...
    event.preventDefault();
              ...
              for (var i=1; i < 7; i++) {
                document.getElementById("P"+i).src="../../Res/Punto.png"; 
     ...
     for (var i=0; i < arrayN.length; i++) 
              {
                ...
                valorE = parseInt(valorE);
                valorE = valorE.toString();      
	            $('#P'+valorE).attr('src', '../../Res/Punto'+valorE+'.png');
                $('#'+elementoT).attr('src', '../../Res/TSi.png');
              }
