...
$('form').keyup(function(e){
  ...
  if(e.keyCode == 13){  
    //alert("creo UsuarioActual " + $(".Nombre").val());  
    //CrearUsuarioActual($(".board").text().toUpperCase());
    //Navega  primero registra Lecciones despues navega a Lista
    //Con  RegistaUsuario() En UsuarioIgreso.js
    Navega();
  
    }
//alert(e.which + "  ff " + e.ctrlKey + "  ff " + e.keyCode);
  //ctrl flecha atras
